...
#  Description: in a word list, determine which words reduce to only a, i or o, and then find the longest words in the list that reduce and return only those 
